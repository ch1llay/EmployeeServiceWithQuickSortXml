...
func (h *Handler) respond(w http.ResponseWriter, response interface{}) {
...
func (h *Handler) GetXMLFileId(w http.ResponseWriter, r *http.Request) {
	...
	h.respond(w, Model.FileReponse{Guid: fileGuid})
